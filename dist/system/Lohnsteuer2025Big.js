System.register(["big.js"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            Lohnsteuer2025 = /** @class */ (function () {
                ...
                */
                function Lohnsteuer2025() {
                    ...
                    /**  geändert für 2025  */
                    this.TAB3 = [new big_js_1.default(0), new big_js_1.default(900), new big_js_1.default(864), new big_js_1.default(828), new big_js_1.default(792), new big_js_1.default(756), new big_js_1.default(720), new big_js_1.default(684), new big_js_1.default(648), new big_js_1.default(612), new big_js_1.default(576), new big_js_1.default(540), new big_js_1.default(504), new big_js_1.default(468), new big_js_1.default(432), new big_js_1.default(396), new big_js_1.default(360), new big_js_1.default(342), new big_js_1.default(324), new big_js_1.default(315), new big_js_1.default(306), new big_js_1.default(297), new big_js_1.default(288), new big_js_1.default(279), new big_js_1.default(270), new big_js_1.default(261), new big_js_1.default(252), new big_js_1.default(243), new big_js_1.default(234), new big_js_1.default(225), new big_js_1.default(216), new big_js_1.default(207), new big_js_1.default(198), new big_js_1.default(189), new big_js_1.default(180), new big_js_1.default(171), new big_js_1.default(162), new big_js_1.default(153), new big_js_1.default(144), new big_js_1.default(135), new big_js_1.default(126), new big_js_1.default(117), new big_js_1.default(108), new big_js_1.default(99), new big_js_1.default(90), new big_js_1.default(81), new big_js_1.default(72), new big_js_1.default(63), new big_js_1.default(54), new big_js_1.default(45), new big_js_1.default(36), new big_js_1.default(27), new big_js_1.default(18), new big_js_1.default(9), new big_js_1.default(0)];
                    /**  Tabelle für die Höchstbeträge des Altersentlastungsbetrags  */
                    /**  geändert für 2025  */
                    this.TAB4 = [new big_js_1.default(0), new big_js_1.default(0.4), new big_js_1.default(0.384), new big_js_1.default(0.368), new big_js_1.default(0.352), new big_js_1.default(0.336), new big_js_1.default(0.32), new big_js_1.default(0.304), new big_js_1.default(0.288), new big_js_1.default(0.272), new big_js_1.default(0.256), new big_js_1.default(0.24), new big_js_1.default(0.224), new big_js_1.default(0.208), new big_js_1.default(0.192), new big_js_1.default(0.176), new big_js_1.default(0.16), new big_js_1.default(0.152), new big_js_1.default(0.144), new big_js_1.default(0.14), new big_js_1.default(0.136), new big_js_1.default(0.132), new big_js_1.default(0.128), new big_js_1.default(0.124), new big_js_1.default(0.12), new big_js_1.default(0.116), new big_js_1.default(0.112), new big_js_1.default(0.108), new big_js_1.default(0.104), new big_js_1.default(0.1), new big_js_1.default(0.096), new big_js_1.default(0.092), new big_js_1.default(0.088), new big_js_1.default(0.084), new big_js_1.default(0.08), new big_js_1.default(0.076), new big_js_1.default(0.072), new big_js_1.default(0.068), new big_js_1.default(0.064), new big_js_1.default(0.06), new big_js_1.default(0.056), new big_js_1.default(0.052), new big_js_1.default(0.048), new big_js_1.default(0.044), new big_js_1.default(0.04), new big_js_1.default(0.036), new big_js_1.default(0.032), new big_js_1.default(0.028), new big_js_1.default(0.024), new big_js_1.default(0.02), new big_js_1.default(0.016), new big_js_1.default(0.012), new big_js_1.default(0.008), new big_js_1.default(0.004), new big_js_1.default(0)];
                ...
                Lohnsteuer2025.prototype.MPARA = function () {
                    if (this.KRV < 1) { /**  &lt; = <  */
                        this.BBGRV = new big_js_1.default(96600); /**  Geändert für 2025  */
                        this.RVSATZAN = new big_js_1.default(0.093);
                    }
                    else {
                        /**  Nichts zu tun  */
                    }
                    this.BBGKVPV = new big_js_1.default(66150); /**  Geändert für 2025  */
                    this.KVSATZAN = (this.KVZ.div(this.ZAHL2).div(this.ZAHL100)).add(new big_js_1.default(0.07));
                    this.KVSATZAG = new big_js_1.default(0.0125).add(new big_js_1.default(0.07)); /**  geändert für 2025  */
                    if (this.PVS == 1) {
                        this.PVSATZAN = new big_js_1.default(0.023); /**  geändert für 2025  */
                        this.PVSATZAG = new big_js_1.default(0.013); /**  geändert für 2025  */
                    }
                    else {
                        this.PVSATZAN = new big_js_1.default(0.018);
                        this.PVSATZAG = new big_js_1.default(0.018); /**  geändert für 2025  */
                    }
                    if (this.PVZ == 1) {
                    ...
                    this.W1STKL5 = new big_js_1.default(13785); /**  geändert für 2025  */
                    this.W2STKL5 = new big_js_1.default(34240); /**  geändert für 2025  */
                    this.W3STKL5 = new big_js_1.default(222260);
                    this.GFB = new big_js_1.default(12096); /**  geändert für 2025  */
                    this.SOLZFREI = new big_js_1.default(19950); /**  geändert für 2025  */
                };
                ...
                Lohnsteuer2025.prototype.MRE4 = function () {
                    if (this.ZVBEZJ.cmp(this.Z_0) == 0) {
                        ...
                        if (this.LZZ == 1) {
                            ...
                            this.HFVB = this.TAB2[this.J].div(this.ZAHL12).mul(new big_js_1.default(this.ZMVB)).round(0, big_js_1.default.roundUp); /**  geändert für 2025  */
                ...
                Lohnsteuer2025.prototype.MZTABFB = function () {
                    ...
                    if (this.STKL == 1) {
                        ...
                        this.KFB = (this.ZKF.mul(new big_js_1.default(9600))).round(0, big_js_1.default.roundDown); /**  geändert für 2025  */
                    }
                    else {
                        if (this.STKL == 2) {
                            ...
                            if (this.STKL == 3) {
                                ...
                                if (this.STKL == 4) {
                                    this.SAP = new big_js_1.default(36);
                                    this.KFB = (this.ZKF.mul(new big_js_1.default(4800))).round(0, big_js_1.default.roundDown); /**  geändert für 2025  */
                                }
                                else {
                                    if (this.STKL == 5) {
                                        this.SAP = new big_js_1.default(36);
                ...
                Lohnsteuer2025.prototype.UPMLST = function () {
                    ...
                    if (this.STKL < 5) {
                        this.UPTAB25(); /**  geändert für 2025  */
                    }
                    else {
                        this.MST5_6();
                    }
                ...
                Lohnsteuer2025.prototype.UPEVP = function () {
                    if (this.KRV == 1) {
                        ...
                        this.VSP1 = (this.ZRE4VP.mul(this.RVSATZAN)).round(2, big_js_1.default.roundDown);
                    }
                ...
                Lohnsteuer2025.prototype.UPTAB25 = function () {
                    if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                        ...
                        if (this.X.cmp(new big_js_1.default(17444)) == -1) { /**  geändert für 2025  */
                            this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, big_js_1.default.roundDown);
                            this.RW = this.Y.mul(new big_js_1.default(932.30)); /**  geändert für 2025  */
                            this.RW = this.RW.add(new big_js_1.default(1400));
                            this.ST = (this.RW.mul(this.Y)).round(0, big_js_1.default.roundDown);
                        }
                        else {
                            if (this.X.cmp(new big_js_1.default(68481)) == -1) { /**  geändert für 2025  */
                                this.Y = (this.X.sub(new big_js_1.default(17443))).div(this.ZAHL10000).round(6, big_js_1.default.roundDown); /**  geändert für 2025  */
                                this.RW = this.Y.mul(new big_js_1.default(176.64)); /**  geändert für 2025  */
                                this.RW = this.RW.add(new big_js_1.default(2397));
                                this.RW = this.RW.mul(this.Y);
                                this.ST = (this.RW.add(new big_js_1.default(1015.13))).round(0, big_js_1.default.roundDown); /**  geändert für 2025  */
                            }
                            else {
                                if (this.X.cmp(new big_js_1.default(277826)) == -1) {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(10911.92))).round(0, big_js_1.default.roundDown); /**  geändert für 2025  */
                                }
                                else {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(19246.67))).round(0, big_js_1.default.roundDown); /**  geändert für 2025  */
                                }
                            }
                        }
                    }
            ...
            exports_1("Lohnsteuer2025", Lohnsteuer2025);
        }
    };
});
