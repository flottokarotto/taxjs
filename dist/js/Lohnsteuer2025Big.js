...
var Lohnsteuer2025 = /** @class */ (function () {
    ...
    Lohnsteuer2025.prototype.MPARA = function () {
        ...
        this.W1STKL5 = new Big(13785); /**  geändert für 2025  */
        this.W2STKL5 = new Big(34240); /**  geändert für 2025  */
        this.W3STKL5 = new Big(222260);
        this.GFB = new Big(12096); /**  geändert für 2025  */
        this.SOLZFREI = new Big(19950); /**  geändert für 2025  */
    };
    ...
    Lohnsteuer2025.prototype.MZTABFB = function () {
        ...
        if (this.STKL == 1) {
            this.SAP = new Big(36);
            this.KFB = (this.ZKF.mul(new Big(9600))).round(0, Big.roundDown); /**  geändert für 2025  */
        }
        else {
            if (this.STKL == 2) {
                ...
                if (this.STKL == 3) {
                    ...
                    if (this.STKL == 4) {
                        this.SAP = new Big(36);
                        this.KFB = (this.ZKF.mul(new Big(4800))).round(0, Big.roundDown); /**  geändert für 2025  */
                    }
                    else {
                        if (this.STKL == 5) {
                            this.SAP = new Big(36);
    ...
    Lohnsteuer2025.prototype.UPTAB25 = function () {
        if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
            ...
            if (this.X.cmp(new Big(17444)) == -1) { /**  geändert für 2025  */
                this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, Big.roundDown);
                this.RW = this.Y.mul(new Big(932.30)); /**  geändert für 2025  */
                this.RW = this.RW.add(new Big(1400));
                this.ST = (this.RW.mul(this.Y)).round(0, Big.roundDown);
            }
            else {
                if (this.X.cmp(new Big(68481)) == -1) { /**  geändert für 2025  */
                    this.Y = (this.X.sub(new Big(17443))).div(this.ZAHL10000).round(6, Big.roundDown); /**  geändert für 2025  */
                    this.RW = this.Y.mul(new Big(176.64)); /**  geändert für 2025  */
                    this.RW = this.RW.add(new Big(2397));
                    this.RW = this.RW.mul(this.Y);
                    this.ST = (this.RW.add(new Big(1015.13))).round(0, Big.roundDown); /**  geändert für 2025  */
                }
                else {
                    if (this.X.cmp(new Big(277826)) == -1) {
                        this.ST = ((this.X.mul(new Big(0.42))).sub(new Big(10911.92))).round(0, Big.roundDown); /**  geändert für 2025  */
                    }
                    else {
                        this.ST = ((this.X.mul(new Big(0.45))).sub(new Big(19246.67))).round(0, Big.roundDown); /**  geändert für 2025  */
                    }
                }
            }
        }
